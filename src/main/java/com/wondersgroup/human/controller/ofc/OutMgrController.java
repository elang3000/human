...
public class OutMgrController extends GenericController {
	 ...
	 * @return: AjaxResult
	 */
	@Log(title = "编辑退出信息", operatorType = OperatorType.BUSINESS, businessType = BusinessType.UPDATE,
	 ...
	 * @return: AjaxResult
	 */
	@Log(title = "删除退出信息", operatorType = OperatorType.BUSINESS, businessType = BusinessType.DELETE,
		     isSaveRequestData = true)
	@ResponseBody
