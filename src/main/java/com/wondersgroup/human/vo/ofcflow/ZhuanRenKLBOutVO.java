...
public class ZhuanRenKLBOutVO {
	...
	public ZhuanRenKLBOutVO() {
		
	}
	
	public ZhuanRenKLBOutVO(ZhuanRenKLBOut d) {
		...
		this.id = d.getId();
		if (d.getZhuanRenKLBOutBatch().getSourceOrgan() != null) {
			this.sourceOrgan = d.getZhuanRenKLBOutBatch().getSourceOrgan().getName();
		}
