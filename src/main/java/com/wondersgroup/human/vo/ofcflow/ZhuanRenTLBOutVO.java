...
public class ZhuanRenTLBOutVO {
	...
	public ZhuanRenTLBOutVO() {
		
	}
	
	public ZhuanRenTLBOutVO(ZhuanRenTLBOut d) {
		...
		this.id = d.getId();
		if (d.getZhuanRenTLBOutBatch().getSourceOrgan() != null) {
			this.sourceOrgan = d.getZhuanRenTLBOutBatch().getSourceOrgan().getName();
		}
