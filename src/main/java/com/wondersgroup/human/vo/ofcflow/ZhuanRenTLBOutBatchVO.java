 ...
 * @since     [产品/模块版本]
 */
public class ZhuanRenTLBOutBatchVO {
	...
	public ZhuanRenTLBOutBatchVO() {
		
	}
	
	public ZhuanRenTLBOutBatchVO(ZhuanRenTLBOutBatch z) {
