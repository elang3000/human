 ...
 * 文件名: OrgFormationMgrFlowVO.java
 * 工程名: human
...
/**
 * @ClassName: OrgFormationMgrFlowVO
 ...
 * @since     [产品/模块版本]
 */
public class OrgFormationMgrFlowVO {
	...
	public OrgFormationMgrFlowVO() {
		
	}
	
	public OrgFormationMgrFlowVO(OrgFormationMgrFlow s) {
		this.id = s.getId();
