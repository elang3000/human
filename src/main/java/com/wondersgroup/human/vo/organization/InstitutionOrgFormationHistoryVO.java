 ...
 * 文件名: InstitutionOrgFormationHistoryVO.java
 * 工程名: human
 * 包名: com.wondersgroup.human.vo.organization
 * 描述: TODO
 * 创建人: jiang
 * 创建时间: 2018年12月5日15:33:29
 * 版本号: V1.0
 * 修改人：jiang
 * 修改时间：2018年12月5日15:33:31
 * 修改任务号
 * 修改内容：TODO
 */
...
/**
 * @ClassName: InstitutionOrgFormationHistoryVO
 * @Description: TODO
 * @author: jiang
...
public class InstitutionOrgFormationHistoryVO {
	...
	public InstitutionOrgFormationHistoryVO() {
		
	}
	
	public InstitutionOrgFormationHistoryVO(InstitutionOrgFormationHistory orgFormationHistory) {
		...
		if (orgFormationHistory.getInstOrgFormationMgrFlow().getOptionType() != null) {
			this.optionType = orgFormationHistory.getInstOrgFormationMgrFlow().getOptionType().getName();
		}
