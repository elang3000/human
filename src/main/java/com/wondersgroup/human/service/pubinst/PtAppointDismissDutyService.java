...
/** 
 * @ClassName: PtAppointDismissDutyService 
 * @Description: 拟任拟免职务 接口
 * @author: lyf
 * @date: 2018年9月2日10:32:18
 * @version [版本号, YYYY-MM-DD]
 * @see       [相关类/方法]
 * @since     [产品/模块版本] 
 */
public interface PtAppointDismissDutyService extends GenericService<PtAppointDismissDuty>{
