 ...
 * @since     [产品/模块版本] 
 */
public interface PtCompetenceService extends GenericService<PtCompetence>{

	Page<PtCompetenceVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
