 ...
 * @since     [产品/模块版本] 
 */
public interface PtEducationService extends GenericService<PtEducation>{

	Page<PtEducationVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
	 ...
	 */
	void delete(PtEducation entity);
}
