 ...
 * @since     [产品/模块版本] 
 */
public interface PtExperienceService extends GenericService<PtExperience>{

	Page<PtExperienceVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
	void SaveOrUpdateExperienceBypost(PtPost post);
}
