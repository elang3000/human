 ...
 * @since     [产品/模块版本]
 */
public interface PtIntoMgrService extends GenericService<PtIntoMgr> {
	
	Page<PtIntoMgrVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
}
