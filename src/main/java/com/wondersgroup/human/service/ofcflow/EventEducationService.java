 ...
 * 
 * 文件名: EventEducationService.java 
 * 工程名: human
...
/** 
 * @ClassName: EventEducationService 
 * @Description: 流程信息 学历 服务接口
 * @author: tzy
 ...
 * @since     [产品/模块版本] 
 */
public interface EventEducationService extends GenericService<EventEducation>{
	/**
