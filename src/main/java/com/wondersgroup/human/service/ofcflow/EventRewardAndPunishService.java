 ...
 * 
 * 文件名: EventRewardAndPunishService.java 
 * 工程名: human
...
/** 
 * @ClassName: EventRewardAndPunishService 
 * @Description: 流程信息 奖励和惩罚 服务接口
 * @author: tzy
 ...
 * @since     [产品/模块版本] 
 */
public interface EventRewardAndPunishService extends GenericService<EventRewardAndPunish>{
	/**
