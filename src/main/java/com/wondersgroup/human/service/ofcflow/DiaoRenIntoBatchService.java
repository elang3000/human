...
/** 
 * @ClassName: DiaoRenBatchService 
 * @Description: 公务员调任 批量数据表 服务接口
 * @author: tzy
 ...
 * @since     [产品/模块版本] 
 */
public interface DiaoRenIntoBatchService extends GenericService<DiaoRenIntoBatch>{
	/**
