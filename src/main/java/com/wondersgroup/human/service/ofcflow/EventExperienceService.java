 ...
 * 
 * 文件名: EventExperienceService.java 
 * 工程名: human
...
/** 
 * @ClassName: EventExperienceService 
 * @Description: 流程信息 简历 服务接口
 * @author: tzy
 ...
 * @since     [产品/模块版本] 
 */
public interface EventExperienceService extends GenericService<EventExperience>{
	/**
