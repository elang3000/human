 ...
 * @since     [产品/模块版本] 
 */
public interface SwDegreeService extends GenericService<SrDegree>{

	Page<SwDegreeVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
