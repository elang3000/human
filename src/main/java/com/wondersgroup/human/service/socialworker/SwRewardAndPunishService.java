 ...
 * @since     [产品/模块版本] 
 */
public interface SwRewardAndPunishService  extends GenericService<SrRewardAndPunish>{
	...
	Page<SwRewardVO> getRewardPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
	Page<SwPunishVO> getPunishPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
