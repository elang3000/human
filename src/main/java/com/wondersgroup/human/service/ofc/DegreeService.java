 ...
 * @since     [产品/模块版本] 
 */
public interface DegreeService extends GenericService<Degree>{

	Page<DegreeVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
