 ...
 * 文件名: ServantBasicInfoService.java
 * 工程名: human
 * 包名: com.wondersgroup.human.service.ofc
 * 描述: TODO
 * 创建人: Wonders-Rain
 * 创建时间: 2018年9月24日 下午4:04:12
 * 版本号: V1.0
 * 修改人：Wonders-Rain
 * 修改时间：2018年9月24日 下午4:04:12
 * 修改任务号
 * 修改内容：TODO
 */
...
/**
 * @ClassName: ServantBasicInfoService
 * @Description: TODO
 * @author: Wonders-Rain
 * @date: 2018年9月24日 下午4:04:12
 * @version [版本号, YYYY-MM-DD]
 * @see       [相关类/方法]
 * @since     [产品/模块版本]
 */
public interface ServantBasicInfoService {
