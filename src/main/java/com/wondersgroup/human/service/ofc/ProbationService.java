 ...
 * @since     [产品/模块版本] 
 */
public interface ProbationService extends GenericService<Probation>{

	Page<ProbationVO> getPage(List<Predicate> filter, Sorts sort, Integer page, Integer limit);
