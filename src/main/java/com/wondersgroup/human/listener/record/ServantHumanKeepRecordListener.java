 ...
 */
@Component
public class ServantHumanKeepRecordListener extends HumanKeepRecordListener<ServantHumamKeepRecordEvent> {


	@Override
	public void onApplicationEvent(ServantHumamKeepRecordEvent event) {
