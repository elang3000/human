 ...
 * @since     [产品/模块版本] 
 */
public class PtManagerInRecordEvent extends PtManagerRecordEvent {
	 ...
	 * @param source 
	 */
	public PtManagerInRecordEvent(PtManagerRecordDTO source) {
		super(source,PtManagerRecord.MANAGER_MANAGER_TYPE_IN);
	}
