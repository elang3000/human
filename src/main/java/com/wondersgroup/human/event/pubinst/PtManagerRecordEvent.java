 ...
 * @since     [产品/模块版本] 
 */
public abstract class PtManagerRecordEvent extends ApplicationEvent{
	 ...
	 * @param source 
	 */
	public PtManagerRecordEvent(Object source) {
		super(source);
		managerType = null;
	}
	 ...
	 * @param source 
	 */
	public PtManagerRecordEvent(Object source,String managerType) {
		super(source);
