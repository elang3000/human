 ...
 * 
 * 文件名: SocialWorkerDao.java
 * 工程名: human
 * 包名: com.wondersgroup.human.repository 
 * 描述: 人员信息维护知识库接口
 * 创建人: lyf
 * 创建时间: 2018年2月22日 上午11:20:27 
 * 版本号: V1.0
 * 修改人：lyf
 * 修改时间：2018年8月22日 上午11:20:27 
 * 修改任务号
 * 修改内容：
 */
...
/** 
 * @ClassName: SocialWorkerDao
 * @Description: 人员信息维护知识库接口
 * @author: lyf
 * @date: 2018年8月22日 上午11:20:27
 * @version [版本号, YYYY-MM-DD]
 * @see       [相关类/方法]
 * @since     [产品/模块版本] 
 */
public interface SocialWorkerRepository extends GenericRepository<SocialWorker>{
