 ...
 */
@Repository
public class SwRewardAndPunishRepositoryImpl extends GenericRepositoryImpl<SrRewardAndPunish> implements SwRewardAndPunishRepository{

	public Class<SrRewardAndPunish> getEntityClass() {
		return SrRewardAndPunish.class;
	}
}
