 ...
 * 
 * 文件名: DiaoRenIntoRepository.java 
 * 工程名: human
 * 包名: com.wondersgroup.human.repository.ofcflow 
 * 描述: 公务员调任 调入情况信息 知识库接口
 * 创建人: tzy   
...
/** 
 * @ClassName: DiaoRenIntoRepository 
 * @Description: 公务员调任 转入情况信息 知识库接口
 * @author: tzy
 ...
 * @since     [产品/模块版本] 
 */
public interface DiaoRenIntoRepository extends GenericRepository<DiaoRenInto>{
