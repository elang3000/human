 ...
 * 
 * 文件名: ZhuanRenTLBIntoRepository.java 
 * 工程名: human
...
/** 
 * @ClassName: ZhuanRenTLBIntoRepository 
 ...
 * @since     [产品/模块版本] 
 */
public interface ZhuanRenTLBIntoRepository extends GenericRepository<ZhuanRenTLBInto>{
