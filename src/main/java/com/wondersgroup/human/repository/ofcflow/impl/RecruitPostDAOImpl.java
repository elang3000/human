...
import com.wondersgroup.human.repository.ofcflow.RecruitPostDAO;
 ...
 */
@Repository
public class RecruitPostDAOImpl  extends GenericRepositoryImpl<RecruitPost> implements RecruitPostDAO{
	 ...
	 */
	@Override
	public Class<RecruitPost> getEntityClass() {

		return RecruitPost.class;
	}
