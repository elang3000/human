...
@Repository
public class JobShiftBRepositoryImpl extends GenericRepositoryImpl<JobShiftB> implements JobShiftBRepository{

	@Autowired
	private DictableService dictableService;

	@Override
	public Class<JobShiftB> getEntityClass() {
		return JobShiftB.class;
	}
