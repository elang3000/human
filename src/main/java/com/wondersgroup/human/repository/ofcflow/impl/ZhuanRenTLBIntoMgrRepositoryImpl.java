 ...
 * 
 * 文件名: ZhuanRenTLBIntoMgrRepositoryImpl.java 
 * 工程名: human
...
/** 
 * @ClassName: ZhuanRenTLBIntoMgrRepositoryImpl 
 ...
 */
@Repository
public class ZhuanRenTLBIntoMgrRepositoryImpl extends GenericRepositoryImpl<ZhuanRenTLBIntoMgr> implements ZhuanRenTLBIntoMgrRepository{

	public Class<ZhuanRenTLBIntoMgr> getEntityClass() {
		return ZhuanRenTLBIntoMgr.class;
	}
