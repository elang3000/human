...
/** 
 * @ClassName: PtAppointDismissDutyRepository 
 * @Description: 拟任拟免职务 dao 接口
 * @author: lyf
 ...
 * @since     [产品/模块版本] 
 */
public interface PtAppointDismissDutyRepository extends GenericRepository<PtAppointDismissDuty>{
