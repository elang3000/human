 ...
 */
@Repository
public class PtCompetenceRepositoryImpl extends GenericRepositoryImpl<PtCompetence> implements PtCompetenceRepository {
	
	public Class<PtCompetence> getEntityClass() {
		
		return PtCompetence.class;
	}
}
