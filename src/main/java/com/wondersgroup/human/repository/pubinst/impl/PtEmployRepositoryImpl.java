 ...
 */
@Repository
public class PtEmployRepositoryImpl extends GenericRepositoryImpl<PtEmploy> implements PtEmployRepository {
	
	public Class<PtEmploy> getEntityClass() {
		
		return PtEmploy.class;
	}
}
