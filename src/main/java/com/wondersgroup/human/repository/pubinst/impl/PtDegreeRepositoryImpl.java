 ...
 */
@Repository
public class PtDegreeRepositoryImpl extends GenericRepositoryImpl<PtDegree> implements PtDegreeRepository {
	
	public Class<PtDegree> getEntityClass() {
		
		return PtDegree.class;
	}
	
	@Override
	public void updateAllDegreeTopTipBySid(String servantId, CodeInfo codeInfo) {
		
		Query query = this.currentSession().createQuery("update com.wondersgroup.human.bo.pubinst.PtDegree set topFlag = :topFlag where publicInstitution.id = :servantId");
