 ...
 */
@Repository
public class PtAssessmentRepositoryImpl extends GenericRepositoryImpl<PtAssessment> implements PtAssessmentRepository {
	
	public Class<PtAssessment> getEntityClass() {
		
		return PtAssessment.class;
	}
}
