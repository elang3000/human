 ...
 */
@Repository
public class PtExperienceRepositoryImpl extends GenericRepositoryImpl<PtExperience> implements PtExperienceRepository {
	
	public Class<PtExperience> getEntityClass() {
		
		return PtExperience.class;
	}
}
