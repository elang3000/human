 ...
 */
@Repository
public class PtIntoMgrRepositoryImpl extends GenericRepositoryImpl<PtIntoMgr> implements PtIntoMgrRepository {

	public Class<PtIntoMgr> getEntityClass() {
		return PtIntoMgr.class;
	}
