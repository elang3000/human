 ...
 */
@Repository
public class PtOutMgrRepositoryImpl extends GenericRepositoryImpl<PtOutMgr> implements PtOutMgrRepository{

	public Class<PtOutMgr> getEntityClass() {
		return PtOutMgr.class;
	}
