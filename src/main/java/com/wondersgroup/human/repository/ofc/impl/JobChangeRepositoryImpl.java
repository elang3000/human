 ...
 */
@Repository
public class JobChangeRepositoryImpl extends GenericRepositoryImpl<JobChange> implements JobChangeRepository {

	public Class<JobChange> getEntityClass() {
		return JobChange.class;
	}
