		...
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="组织类型管理" cite="true"></smart:breadcrumbNavMenuItem>
				</smart:breadcrumbNavMenu>
			</smart:cardHead>
			<smart:cardBody>
				<smart:gridRow>
					<smart:fieldSet title="组织类型查询" color="blue" style="padding-top:1em;">
						<smart:form id="searchForm">
							<smart:gridRow>
								<smart:gridColumn colPart="4">
									<smart:textInput labelName="组织类型编码：" autocomplete="off" placeholder="组织类型编码" name="code"></smart:textInput>
								</smart:gridColumn>
								<smart:gridColumn colPart="4">
									<smart:textInput labelName="组织类型名称：" autocomplete="off" placeholder="组织类型名称" name="name"></smart:textInput>
								</smart:gridColumn>
								<smart:gridColumn colPart="4">
									<smart:buttonGroup container="true">
										...
										<smart:button size="sm" method="history" title="重置" theme="primary" type="reset">
					   					...
					   					<smart:button size="sm" method="new" title="新增组织类型" theme="normal">
											<smart:icon icon="plus"></smart:icon>&nbsp;新增组织类型
									   	</smart:button>
									</smart:buttonGroup>
								</smart:gridColumn>
							</smart:gridRow>
					...
					<smart:gridColumn>
						<smart:table id="navigationList" url="system/organ/tree/type/query/page" height="full-200" sortField="name" sortType="asc" text="未找到数据！" page="true">
							<tr>
								<smart:tableItem field="code" width=".25" sort="true">组织类型编码</smart:tableItem>
								<smart:tableItem field="name" width=".25" sort="true">组织类型名称</smart:tableItem>
							...
							<smart:tableToolBar id="navListToolBar">
								...
								<smart:tableToolBtn theme="warn" event="rule" title="组织类型规则维护">
	...
	<smart:scriptHead models="form,layer,element,table">
		<smart:tableScriptAction tableId="navigationList">
			edit : function(data) {
				smart.show({
					title : '修改组织类型信息',
					url : 'system/organ/tree/type/edit',
					params : {
						id : data.data.id
					},
					scrollbar : false
			...
			remove : function(data) {
				smart.confirm({
					...
					message:'确认删除组织类型？',
					type:'POST',
					url:'system/organ/tree/type/remove/save',
			...
			rule:function(data) {
				smart.show({
					title : '维护组织类型规则',
					url : 'system/organ/tree/rule/index',
					size : 'full',
					params : {
						id : data.data.id
					},
		...
		<smart:buttonScriptAction>
			new : function() {
				smart.show({
					title : '新增组织类型',
					url : 'system/organ/tree/type/create',
					scrollbar : false
				});
			},
			search : function() {
