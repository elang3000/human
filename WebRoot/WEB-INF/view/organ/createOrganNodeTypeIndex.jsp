...
<smart:body>
					...
					<smart:form id="saveForm">
						<smart:gridRow>
							<smart:gridColumn colPart="8">
								<smart:textInput labelName="节点类型编码：" autocomplete="off" placeholder="请输入组织节点类型编码" verify="required" name="code" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="8">
								<smart:textInput labelName="节点类型名称：" autocomplete="off" placeholder="请输入组织节点类型名称" verify="required" name="name" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						...
						<smart:gridRow style="margin-top:0px;">
							<smart:gridColumn colPart="8">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="radio" name="people" value="1" title="是" checked>
										<input type="radio" name="people" value="0" title="否">
									</div>
								</div>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow style="margin-top:0px;">
							<smart:gridColumn colPart="8">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="radio" name="relation" value="1" title="是" checked>
										<input type="radio" name="relation" value="0" title="否">
									</div>
								</div>
							</smart:gridColumn>
						</smart:gridRow>
	...
	<smart:scriptHead models="form,layer,element">
		...
		form.on('submit(smart-submit)', function(obj) {
			...
			$.post('system/organ/node/type/create/save',
				obj.field,
				function(result) {	
					layer.close(mask);
					if (result.success) {
