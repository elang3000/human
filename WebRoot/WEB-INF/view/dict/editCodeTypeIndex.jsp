...
<smart:body>
						...
						<smart:gridRow>
							<smart:gridColumn colPart="8">
								<smart:textInput labelName="字典类型代码：" autocomplete="off"
									...
									value="${type.code}" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="8">
								<smart:textInput labelName="字典类型名称：" autocomplete="off"
									...
									value="${type.name}" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
						...
						<smart:gridRow>
							<smart:gridColumn colPart="8">
								<smart:textInput labelName="显示序列：" autocomplete="off"
									...
									value="${type.dispOrder}" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="8">
								<smart:textInput labelName="层级限制：" autocomplete="off"
									...
									value="${type.level}" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow style="margin-top:0px;">
							<smart:gridColumn colPart="8">
								<smart:textarea name="description" labelName="描述信息"
									display="block">${type.description}</smart:textarea>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="8">
	...
	<smart:scriptHead models="form,layer,element,linkSelect">
		...
		form.on('submit(smart-submit)', function(obj) {
			...
			$.post('system/dict/type/edit/save',
				obj.field,
				function(result) {	
					layer.close(mask);
					if (result.success) {
