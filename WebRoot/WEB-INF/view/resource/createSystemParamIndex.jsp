	...
	<smart:grid>
		<div class="layui-card">
			<div class="layui-card-body">
				<smart:fieldSet title="新增系统参数信息" color="blue" style="padding-top:1em;">
					<smart:form id="saveForm">
						<smart:gridRow>
							<smart:gridColumn colPart="6">
								<smart:textInput labelName="系统参数编码：" autocomplete="off" placeholder="请输入系统参数编码" verify="required" name="code" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
							<smart:gridColumn colPart="6">
								<smart:textInput labelName="系统参数名称：" autocomplete="off" placeholder="请输入系统参数名称" verify="required" name="name" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
							<smart:gridColumn colPart="6">
							...
							<smart:gridColumn colPart="6">
								<smart:textInput labelName="系统参数值：" autocomplete="off" placeholder="请输入系统参数名称" verify="required" name="value" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
