							...
							<smart:cardBody>
								<script>
									function loadMenuById(event, treeId, menu) {
										...
										iframe.attr("src","resource/menu/load?id=" + menu.id);
										iframe.height = document.documentElement.clientHeight;
										$(".layui-col-md9").css("height", iframe.height - 100 + 'px');
									};
								</script>
								<smart:customDynamicTree id="treeArea" url="resource/menu/list?appId=${appId}" style="border:1px solid #e6e6e6;height:100%;" cutSize="155" customEvent="true" funcType="onClick"
									funcName="loadMenuById" />
							</smart:cardBody>
						</smart:card>
					</smart:gridColumn>
					<smart:gridColumn colPart="9">
						<iframe src="resource/menu/load?id=${rootMenuId}" frameborder="0" id="menuDetailIframe" class="layadmin-iframe" onload="renderIframe()"></iframe>
					</smart:gridColumn>
				</smart:gridRow>
			</smart:cardBody>
		</smart:card>
