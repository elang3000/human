...
<smart:body>
	<smart:grid>
		<div class="layui-card">
			<div class="layui-card-body">
				<smart:fieldSet title="新增系统报表信息" color="blue" style="padding-top:1em;">
					<smart:form id="saveForm">
						<smart:gridRow>
							<smart:gridColumn colPart="12">
								<smart:textInput labelName="报表编码：" autocomplete="off" placeholder="请输入系统报表编码" verify="required" name="code" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
							<smart:gridColumn colPart="12">
								<smart:textInput labelName="报表名称：" autocomplete="off" placeholder="请输入系统报表名称" verify="required" name="name" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
							<smart:gridColumn colPart="12">
								<smart:textInput labelName="报表路径：" autocomplete="off" placeholder="请输入系统报表模板路径" verify="required" name="template" isNotNull="true">
								</smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
	...
	<smart:scriptHead models="form,layer,element">
		...
		form.on('submit(smart-submit)', function(obj) {
			...
			$.post('system/report/create/save',
				obj.field,
				function(result) {	
					layer.close(mask);
					if (result.success) {
