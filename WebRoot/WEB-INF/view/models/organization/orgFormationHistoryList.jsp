				...
				<smart:gridRow>
					...
					<smart:gridColumn colPart="9">
						...
						<smart:gridRow colSpace="5">
							<smart:gridColumn>
								<smart:table id="navigationList_orgFormationHistoryList" url="orgFormationHistory/pageList" text="未找到单位数据！" page="true" height="full-245">
									<tr>
		...
		<smart:tableScriptAction tableId="navigationList_orgFormationHistoryList" checkbox="true"
			...
			view : function(data) {
				smart.show({
					title : '调整历史查看',
					size : 'full',
					url : 'orgFormationHistory/view?id='+data.data.id,
					scrollbar : false,
				});
			}
