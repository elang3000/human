...
<smart:initHead title="长宁区人事管理信息系统--机构编制调整历史列表" />
</head>
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="机构编制调整历史" cite="true"></smart:breadcrumbNavMenuItem>
				...
				<smart:gridRow>
					...
					<smart:gridColumn colPart="9">
						...
						<smart:gridRow colSpace="5">
							<smart:gridColumn>
								<smart:table id="navigationList_orgFormationHistoryList" url="institutionOrgFormationHistory/pageList" text="未找到单位数据！" page="true" height="full-245">
									<tr>
	...
	<smart:scriptHead models="table,form,layer,element">
		<smart:utils />
		<smart:tableScriptAction tableId="navigationList_orgFormationHistoryList" checkbox="true"
			sort="true" rowEdit="true">    
			view : function(data) {
				smart.show({
					title : '调整历史查看',
					size : 'full',
					url : 'institutionOrgFormationHistory/view?id='+data.data.id,
					scrollbar : false,
				});
			}
		...
		<smart:buttonScriptAction>
			search_list : function() {
				...
				table.reload('navigationList_orgFormationHistoryList', {
					where : params,
					page : {
						curr : 1
					}
