			...
			<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem turnurl="analysis/general/generalQueryList" show="false" eId="" itemName="公务员综合查询"></smart:tabPanelItem>
							<smart:tabPanelItem turnurl="business/personel/businessQueryList" show="false" eId="" itemName="事业人员综合查询"></smart:tabPanelItem>
							<smart:tabPanelItem show="true" eId="" itemName="国企职工综合查询"></smart:tabPanelItem>
									...
									<div class="layui-tab">
										...
										<div class="layui-tab-content">
											...
											<smart:gridRow colSpace="5">
												<smart:gridColumn>
													<smart:table id="navigationList_ofcList" url="company/pageList" text="未找到用户数据！" height="full-285" page="true">
														<tr>
															...
															<smart:tableItem field="cardNo" width="120" sort="true">身份证号</smart:tableItem>
	...
	<smart:scriptHead models="table,form,layer,element">
		...
		<smart:tableScriptAction tableId="navigationList_ofcList" checkbox="true"
			...
			edit_ofcList : function(data) {
				window.location.href='company/main?id='+data.data.id;
			}
		...
		<smart:buttonScriptAction>
			...
			nationalCompanyImport : function() {
				smart.show({
					title:'国企人员导入',
					url:'company/draftNationalCompanyImport',
					scrollbar:false
				});
			},
