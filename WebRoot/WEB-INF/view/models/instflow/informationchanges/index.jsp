...
<html>
<head>
<smart:initHead title="上海市公务员信息管理系统--人员信息变动审核" />
</head>
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="人员信息变动审核" cite="true"></smart:breadcrumbNavMenuItem>
...
<%-- 												<smart:tableItem isCheckbox="true">全选</smart:tableItem>
 --%>												<smart:tableItem field="name" width="100" sort="true">姓名</smart:tableItem>
											...
											<smart:tableToolBar id="navListToolBar_ofcList">
												<smart:tableToolBtn theme="warm" event="add" title="人员信息变更">
													<smart:icon icon="edit">人员信息变更</smart:icon>
												</smart:tableToolBtn>
											</smart:tableToolBar>
										</smart:table>
									</smart:gridColumn>
		...
		<smart:tableScriptAction tableId="navigationList_ofcList" checkbox="true"
			...
			add : function(data) {
			    smart.show({
					title : '人员信息变更添加',
					size : 'full',
					url : "instflow/informationchanges/informationChangeApply?id=" + data.data.id,
					scrollbar : false
				});
			}
