...
<html>
<head>
<smart:initHead title="上海市公务员信息管理系统--离退备案" />
</head>
<smart:body>
	<smart:grid>
		<smart:card>
...
<%-- 												<smart:tableItem isCheckbox="true">全选</smart:tableItem>
 --%>												<smart:tableItem field="name" width="100" sort="true">姓名</smart:tableItem>
											...
											<smart:tableToolBar id="navListToolBar_ofcList">
												<smart:tableToolBtn theme="warm" event="add" title="离退备案">
													<smart:icon icon="edit">离退备案</smart:icon>
												</smart:tableToolBtn>
											</smart:tableToolBar>
										</smart:table>
									</smart:gridColumn>
		...
		<smart:tableScriptAction tableId="navigationList_ofcList" checkbox="true"
			...
			add : function(data) {
			    smart.show({
					title : '离退人员备案信息添加',
					size : 'full',
					url : "instflow/recordablerecord/recordApply?id=" + data.data.id,
					scrollbar : false
				});
			}
