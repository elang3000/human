		...
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="公务员进出管理统计" cite="true"></smart:breadcrumbNavMenuItem>
					...
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList"
							...
							<tr>
								...
								<smart:tableItem field="in" width=".23">进</smart:tableItem>
								<smart:tableItem field="out" width=".23">出</smart:tableItem>
								<smart:tableItem field="mag" width=".23">管理</smart:tableItem>
