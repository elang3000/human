				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList"
							url="analysis/specialCount/punish/list" height="full-155" 
							text="未找到有效数据！">
							<tr>
								<smart:tableItem field="departName" width=".18">单位</smart:tableItem>
								<smart:tableItem field="fire" width=".12">开除</smart:tableItem>
								<smart:tableItem field="warn" width=".12">警告</smart:tableItem>
								<smart:tableItem field="seriousDemerit" width=".12">记大过</smart:tableItem>
								<smart:tableItem field="demerit" width=".12">记过</smart:tableItem>
								<smart:tableItem field="degrade" width=".12">降级</smart:tableItem>
								<smart:tableItem field="dismiss" width=".12">撤职</smart:tableItem>
        ...
        <smart:tableScriptAction tableId="navigationList"
            ...
            view : function(data) {
	            ...
	            smart.show({
		            title : '单位详情查看',
		            size : 'full',
		            url : 'analysis/specialCount/punish/view?departId='+data.data.departId+'&year='+year+'&departName='+data.data.departName,
		            scrollbar : false
	            });
            }
