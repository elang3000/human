		...
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="挂职锻炼管理" cite="true"></smart:breadcrumbNavMenuItem>
			...
			<smart:cardBody>
						...
						<smart:form>
							<smart:gridRow>
								...
								<smart:gridColumn colPart="3" colOffset="1">
									...
									<shiro:hasPermission name="ADD_EXERCISE_BTN">
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/exercise/infoList"
							height="full-150" text="未获取到数据！" doneCallBack="fixedCol">
							<tr>
							...
							<script type="text/html" id="navListToolBar">
										{{#  if(d.status=="1"){ }}
										<shiro:hasPermission name="EDIT_EXERCISE_BTN">
											<a class="layui-btn layui-btn-xs layui-btn-default" lay-event="edit"  title="编辑">
												<i class="fa fa-edit"></i>
											</a>
										</shiro:hasPermission>
										<shiro:hasPermission name="REMOVE_EXERCISE_BTN">
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '挂职锻炼信息',
					size : 'full',
					url : "ofcflow/exercise/edit?id="+data.data.id,
					scrollbar : false
				});
			}
			,view : function(data) {
				smart.show({
					title : '挂职锻炼信息',
					size : 'full',
					url : "ofcflow/exercise/toView?id="+data.data.id,
					scrollbar : false
				});
			}
