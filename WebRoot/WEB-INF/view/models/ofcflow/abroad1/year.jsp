...
<smart:body>
	<smart:grid>
		<smart:card>
			...
			<smart:cardBody>
				<smart:form action="ofcflow/abroadB/saveYearPlan">
					<smart:fromTokenTag/>
					<smart:gridRow>
						<smart:gridRow>
						...
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:textInput name="name" labelName="出境团组名称："
									value="${abroadYearPlan.name}" placeholder="出境团组名称"></smart:textInput>
									<smart:textInput type="hidden" id="id" name="id" value="${abroadYearPlan.id }"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:textInput name="country" labelName="出境地区："
									value="${abroadYearPlan.country}" placeholder="出境地区"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:numberInput name="day" labelName="停留天数：" max="1000" min="0" type="text" 
									value="${abroadYearPlan.day}" placeholder="停留天数" display="block" isInt="true"></smart:numberInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
						...
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								...
								<smart:textInput type="hidden" id="state" name="state" value="${abroadYearPlan.state}"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
					</smart:gridRow>
					<smart:gridRow>
