			...
			<smart:cardBody>
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/exchange/intoList"
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '参公交流管理',
					size : 'full',
					url : "ofcflow/exchange/edit?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '参公交流管理',
					size : 'full',
					url : "ofcflow/exchange/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
