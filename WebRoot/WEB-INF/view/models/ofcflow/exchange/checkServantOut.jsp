...
<smart:body>
	<smart:grid>
		<smart:card>
			...
			<smart:cardBody>
				<smart:form action="ofcflow/exchangeOut/edit">
					<smart:fromTokenTag/>
		...
		<smart:buttonScriptAction>
			checkServant : function(data) {
				...
				if(name&&name!=""&&cardNo&&cardNo!=""){
					var requestConfig = {};
					requestConfig.url = "ofcflow/exchangeOut/checkServant";
			...
			,save : function() {
				if($("#status").val()=="1"){
					...
					window.location.href="ofcflow/exchangeOut/edit?servantId="+id+"&id="+zhuanRenId;
				}
			}
		</smart:buttonScriptAction>
	</smart:scriptHead>
