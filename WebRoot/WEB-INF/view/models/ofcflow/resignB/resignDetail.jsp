			...
			<smart:gridRow colSpace="5">
				<smart:gridColumn>
					...
					<smart:grid>
								...
								<smart:gridRow>
									<smart:gridColumn colPart="12">
										<img
											...
											alt="照片" src="ftp/getImg?imgName=${servant.photoPath}">
									</smart:gridColumn>
								</smart:gridRow>
							</smart:gridColumn>
						</smart:gridRow>
						...
						<smart:gridRow>
							<smart:gridColumn colPart="4">
								<smart:infoShowerLabel infoname="邮政编码"
						...
						<smart:gridRow>
							...
							<smart:gridColumn colPart="4">
								<smart:infoShowerLabel infoname="基础工作年限"
									infovalue="${servant.grassRootYear}"></smart:infoShowerLabel>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4">
								<smart:infoShowerLabel shortName="现任最高职务" infoname="现任最高职务名称"
					...
					<smart:grid>
						<smart:form id="editForm" action="ofcflow/resignB/operationFlow">
							<smart:gridRow>
								<smart:gridColumn>
									<smart:gridRow>
										<smart:textInput type="hidden" id="humanId" name="humanId"
											value="${servant.id}"></smart:textInput>
										<smart:textInput type="hidden" id="humanId" name="id"
											value="${resignPeople.id}"></smart:textInput>
										<smart:textInput type="hidden" id="result" name="result"></smart:textInput>
										<smart:gridColumn colPart="4">
											<smart:infoShowerLabel infoname="辞职原因"
												infovalue="${resignPeople.reason.name}"></smart:infoShowerLabel>
										</smart:gridColumn>
										<smart:gridColumn colPart="4">
											<smart:infoShowerLabel infoname="辞职去向"
												infovalue="${resignPeople.resignWhereabouts.name}"></smart:infoShowerLabel>
										</smart:gridColumn>
										<smart:gridColumn colPart="4">
											<smart:infoShowerLabel infoname="辞职时间"
												infovalue="${resignPeople.resignDate}"></smart:infoShowerLabel>
										</smart:gridColumn>
									</smart:gridRow>
									<smart:gridRow>
										<smart:gridColumn>
											<smart:infoShowerLabel infoname="备注"
												infovalue="${resignPeople.remark}"></smart:infoShowerLabel>
										</smart:gridColumn>
									</smart:gridRow>
								</smart:gridColumn>
								...
								<smart:gridRow>
									...
									<smart:gridColumn colPart="4" deviceType="md" colOffset="4">
										<smart:buttonGroup container="true">
											<smart:button theme="primary" size="sm" method="goBack"
												title="返回">
