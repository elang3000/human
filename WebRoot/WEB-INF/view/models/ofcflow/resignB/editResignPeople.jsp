...
<smart:body>
							...
							<smart:gridRow>
								<smart:gridColumn>
									<smart:gridRow>
										...
										<smart:textInput type="hidden" name="id" value="${resignPeople.id}"></smart:textInput>
										<smart:gridColumn colPart="4">
											<smart:singleSelect initSelectedKey="${resignPeople.reason.id }" isNotNull="true" verify="required" name="reason.id" labelName="辞职原因：" 
												display="block" url="dictquery/sub/code/DM009/5" isAddDefaltOption="true">
											</smart:singleSelect>
										</smart:gridColumn>
										<smart:gridColumn colPart="4">
											<smart:singleSelect initSelectedKey="${resignPeople.resignWhereabouts.id }" isNotNull="true" verify="required" name="resignWhereabouts.id" labelName="辞职去向："
											 display="block" url="dictquery/sub/code/ResignWhereabouts" isAddDefaltOption="true"></smart:singleSelect>
										</smart:gridColumn>
									</smart:gridRow>
									<smart:gridRow>
										<smart:gridColumn colPart="8">
											<smart:textarea labelName="备注：" name="remark" display="block">${resignPeople.remark}</smart:textarea>
										</smart:gridColumn>
									</smart:gridRow>
								</smart:gridColumn>
							</smart:gridRow>
	...
	<smart:scriptHead models="table,form,layer,element,laydate">
		...
		form.on('submit(save)', function (data) {//表单保存
			...
			var url= 'ofcflow/resignB/saveResignPeople';
