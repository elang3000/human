		...
		<smart:cardHead>
			<smart:gridRow>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="公务员死亡" cite="true"></smart:breadcrumbNavMenuItem>
				...
				<smart:gridColumn>
					...
					<smart:grid>
						...
						<smart:fromTokenTag/>
							<smart:gridRow>
								<smart:gridColumn>
									<smart:textInput type="hidden" id="status" name="status"
										value="1"></smart:textInput>
									<smart:textInput type="hidden" name="servant.id"
										value="${servant.id}"></smart:textInput>
									<smart:textInput type="hidden" id="unitName" name="unitName"
										value="${servant.departName}"></smart:textInput>
										<smart:textInput type="hidden" name="organ.id" value="${servant.departId}"></smart:textInput>
									<smart:gridRow>
										<smart:gridColumn colPart="6">
											<smart:singleSelect display="block" labelName="死亡原因："
														name="reason.id" url="dictquery/sub/code/DEATHREASON"
											isAddDefaltOption="true" isNotNull = "true"  verify="required"></smart:singleSelect>
										</smart:gridColumn>
										
										<smart:gridColumn colPart="6">
											<smart:date labelName="死亡时间：" display="block"
												isNotNull="true" verify="required" name="deathDate" id="deathDate"></smart:date>
										</smart:gridColumn>
									</smart:gridRow>

									<smart:gridRow>
										<smart:gridColumn>
											<smart:textarea labelName="备注：" display="block" name="remark"></smart:textarea>
										</smart:gridColumn>
									</smart:gridRow>
								</smart:gridColumn>
							</smart:gridRow>
								...
								<smart:gridColumn>
									<smart:buttonGroup container="true">
										<smart:button id="save" other="lay-submit" size="sm"
											title="死亡" theme="normal">
											<smart:icon icon="check"></smart:icon>&nbsp;死亡
								</smart:button>
		...
		form.on('submit(save)', function (data) {//表单保存
			...
			smart.confirm({
					...
					try{
                        ...
                        parent.parent.layui.table.reload('navigationList');
