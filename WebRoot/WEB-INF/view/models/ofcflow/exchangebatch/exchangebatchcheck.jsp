...
<html>
<head>
<smart:initHead title="参公交流--编制校验" />
</head>
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardBody>
				<smart:form id="editForm">
					...
					<smart:gridRow>
						<smart:title title="参公交流单位编制信息" style="margin-top: 5px;" color="blue" />
					</smart:gridRow>
					...
					<smart:gridRow>
						...
						<smart:gridColumn colPart="4">
							<smart:textInput name="sumNumber" id="sumNumber" labelName="交流总人数" placeholder="交流总人数，自动计算"
		...
		form.on('submit(save)', function (data) {//表单保存
			...
			smart.confirm({
				...
				callback : function(){
					...
					window.location.href="ofcflow/exchangeB/servantList?id="+this.data;
				}
			});
		});
	</smart:scriptHead>
