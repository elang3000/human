			...
			<smart:cardBody>
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/zrklbInto/intoList"
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '跨类别转任管理',
					size : 'full',
					url : "ofcflow/zrklbInto/edit?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '跨类别转任管理',
					size : 'full',
					url : "ofcflow/zrklbInto/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
