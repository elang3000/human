			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem turnurl="ofcflow/zrklbInto/flow" show="false" eId="" itemName="流程审批"></smart:tabPanelItem>
						</smart:tabPanel>
						...
						<smart:form>
							<smart:gridRow>
								...
								<smart:gridColumn colPart="3" colOffset="1">
									...
									<shiro:hasPermission name="ADD_ZHUANREN_KLB_OUT_BTN">
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/zrklbOut/infoList"
							...
							<script type="text/html" id="navListToolBar">
										{{#  if(d.status=="0"){ }}
										<shiro:hasPermission name="EDIT_ZHUANREN_KLB_OUT_BTN">
											<a class="layui-btn layui-btn-xs layui-btn-default" lay-event="edit"  title="编辑">
												<i class="fa fa-edit"></i>
											</a>
										</shiro:hasPermission>
										<shiro:hasPermission name="REMOVE_ZHUANREN_KLB_OUT_BTN">
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrklbOut/edit?id="+data.data.id,
					scrollbar : false
				});
			}
			,flow : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrklbOut/toFlow?id="+data.data.id,
					scrollbar : false
				});
			}
			,view : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrklbOut/toView?id="+data.data.id,
					scrollbar : false
				});
			}
