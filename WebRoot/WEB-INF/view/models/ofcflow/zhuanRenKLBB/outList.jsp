			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							<smart:tabPanelItem turnurl="ofcflow/zrklbIntoB/index" show="false"
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/zrklbOutB/outList"
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrklbOutB/servantList?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrklbOutB/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
		...
		<smart:buttonScriptAction>
			...
			add : function() {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrklbOutB/selectOrg",
					scrollbar : false
				});
			}
		 </smart:buttonScriptAction>
