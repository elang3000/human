			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem turnurl="ofcflow/zrklbOutB/index" show="false"
								eId="" itemName="转出情况列表"></smart:tabPanelItem>
							<smart:tabPanelItem turnurl="ofcflow/zrklbIntoB/flow" show="false"
						...
						<smart:form>
							<smart:gridRow>
								<smart:gridColumn colPart="3">
									<smart:singleSelect labelName="转任区域" isAddDefaltOption="true"
									...
									<div class="layui-form-item">
										<div class="layui-inline">
											...
											<div class="layui-input-inline" style="width: 100px;">
												<input onblur="numberValidate(this,true);" type="text"
													autocomplete="off" class="layui-input" max="1000" min="0"
													step="1" name="sumNumberE" title="转任人数止"
													placeholder="转任人数止">
											</div>
										</div>
									</div>
								...
								<smart:gridColumn colPart="3">
									<smart:buttonGroup container="true">
										...
										<shiro:hasPermission name="ADD_ZHUANREN_KLB_INTO_BTN">
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/zrklbIntoB/intoList"
							height="full-210" text="未获取到数据！">
							<tr>
								<smart:tableItem field="targetOrgan" width=".1">转入单位</smart:tableItem>
								<smart:tableItem field="areaType" width=".1" sort="true">转任区域</smart:tableItem>
								...
								<smart:tableItem field="sumNumber" width=".1" sort="true">转任总人数</smart:tableItem>
							...
							<script type="text/html" id="navListToolBar">
										{{#  if(d.status=="0"){ }}
										<shiro:hasPermission name="EDIT_ZHUANREN_KLB_INTO_BTN">
											<a class="layui-btn layui-btn-xs layui-btn-default" lay-event="edit"  title="编辑">
												<i class="fa fa-edit"></i>
											</a>
										</shiro:hasPermission>
										<shiro:hasPermission name="REMOVE_ZHUANREN_KLB_INTO_BTN">
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '跨类别转任管理',
					size : 'full',
					url : "ofcflow/zrklbIntoB/servantList?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '跨类别转任管理',
					size : 'full',
					url : "ofcflow/zrklbIntoB/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
