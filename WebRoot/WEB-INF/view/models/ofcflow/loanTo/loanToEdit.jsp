...
<smart:body>
			...
			<smart:cardHead>
				<smart:gridRow>
					<smart:breadcrumbNavMenu separator=">">
						...
						<smart:breadcrumbNavMenuItem iname="借调" cite="true"></smart:breadcrumbNavMenuItem>
					...
					<smart:gridRow>
						<smart:gridColumn colPart="8">
							<smart:gridRow>
								...
								<smart:gridColumn colPart="6">
									<smart:textInput otherAttr="disabled" labelName="身份证号：" name="cardNo" display="block" value="${s.cardNoView}"></smart:textInput>
								</smart:gridColumn>
							</smart:gridRow>
							<smart:gridRow>
								<smart:gridColumn colPart="6">
							...
							<smart:gridRow>
								<smart:gridColumn colPart="6">
									<smart:textInput otherAttr="disabled" labelName="职务：" name="postName" display="block" value="${s.nowPostName}"></smart:textInput>
								</smart:gridColumn>
								<smart:gridColumn colPart="6">
									<smart:textInput otherAttr="disabled" labelName="级别：" name="jobLevel" display="block" value="${s.nowJobLevel.name}"></smart:textInput>
								</smart:gridColumn>
							</smart:gridRow>
							<smart:gridRow>
								<smart:gridColumn colPart="6">
						...
						<smart:gridColumn colPart="3" colOffset="1">
							<smart:gridRow>
								<smart:gridColumn colPart="12">
									<img style="width:150px;height:200px;min-width:150px;min-height:200px;" name="photoPath" alt="照片" src="ftp/getImg?imgName=${s.photoPath}">
								</smart:gridColumn>
							</smart:gridRow>
						</smart:gridColumn>
					</smart:gridRow>
					<smart:gridRow>
						<smart:title title="借调信息" style="margin-top: 5px;" color="blue" />
					</smart:gridRow>
					<smart:gridRow>
						...
						<smart:gridColumn colPart="4">
							<smart:date isNotNull="true" verify="required"
										labelName="借调开始时间：" name="startDate" id="startDate"
										value="${d.startDate}" display="block"></smart:date>
						</smart:gridColumn>
						<smart:gridColumn colPart="4">
							<smart:date labelName="借调结束时间：" name="endDate" id="endDate"
	...
	<smart:scriptHead models="table,form,layer,element,selectResource,laydate">
		...
		<smart:initSelectResource verify="required" value="${s.name}" hiddenValue="${s.id}" id = "selectNameTag" name="servant.name" hiddenName="servant.id" winSize="lg" winTitle="选择人员信息" winUrl="orgInfo/selectServant?createOrganNodeId=${createOrganNodeId}" 
		...
		form.on('submit(save)', function (data) {//表单保存
 		...
 		form.on('submit(submit)', function (data) {//表单提交
 			smart.confirm({
				title:'保存借调信息',
				message:'确认提交保存吗？',
				url:'ofcflow/loanto/operationFlow',
				params : smart.json("#editForm"),
				callback : function(){
					parent.layui.table.reload('navigationList');
					var index=parent.layer.getFrameIndex(window.name);
