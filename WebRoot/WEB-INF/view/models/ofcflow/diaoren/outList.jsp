			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem turnurl="ofcflow/diaoren/flow" show="false" eId="" itemName="流程审批"></smart:tabPanelItem>
						</smart:tabPanel>
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/diaorenOut/infoList"
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '调出管理',
					size : 'full',
					url : "ofcflow/diaorenOut/edit?id="+data.data.id,
					scrollbar : false
				});
			}
			,flow : function(data) {
				smart.show({
					title : '调出管理',
					size : 'full',
					url : "ofcflow/diaorenOut/toFlow?id="+data.data.id,
					scrollbar : false
				});
			}
			,view : function(data) {
				smart.show({
					title : '调出管理',
					size : 'full',
					url : "ofcflow/diaorenOut/toView?id="+data.data.id,
					scrollbar : false
				});
			}
