		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '公务员试用结果',
					size : 'full',
					url : "ofcflow/diaoren/edit?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '调任信息',
					size : 'full',
					url : "ofcflow/diaoren/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
