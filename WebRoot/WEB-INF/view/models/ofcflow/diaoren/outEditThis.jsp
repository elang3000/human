			...
			<smart:cardBody>
				<smart:form id="editForm">
					...
					<smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4">
								<smart:singleSelect id="postCode" isNotNull="true" verify="required"
									initSelectedKey="${d.postCode.id}" name="postCode.id" isSaveShowName="true" inputShowName="postName"
						...
						<smart:gridColumn colPart="4">
							<smart:singleSelect labelName="调往单位：" name="targetOrgan.id" isSearch="true" display="block" url="system/organ/node/query?organTreeId=394e21fa-1eb6-42ee-ba32-50655fa16517" isAddDefaltOption="true" initSelectedKey="${d.targetOrgan.id }" isNotNull="true" verify="required" ></smart:singleSelect>
						</smart:gridColumn>
						<smart:gridColumn colPart="4">
