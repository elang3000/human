					...
					<smart:gridColumn>
						...
						<smart:grid>
							...
							<smart:gridRow>
								...
								<smart:gridColumn colPart="4">
									<smart:infoShowerLabel infoname="决定或批准免职的文号" shortName="批准免职文号"
							...
							<smart:gridRow>
								<smart:gridColumn colPart="4"> 
									<smart:infoShowerLabel infoname="决定或批准免职的日期" shortName="批准免职日期"
							...
							<smart:gridRow>
								...
								<smart:gridColumn colPart="4">
									<smart:infoShowerLabel infoname="免职决定做出方式" shortName="免职决定方式"
