					...
					<smart:gridColumn>
						...
						<smart:grid>
							...
							<smart:gridRow>
								...
								<smart:gridColumn colPart="4">
									<smart:textInput labelName="决定或批准免职的文号：" shortName="批准免职文号"
							...
							<smart:gridRow>
								<smart:gridColumn colPart="4">
									<smart:date labelName="决定或批准免职的日期：" shortName="批准免职日期" isNotNull="true"
								...
								<smart:gridColumn colPart="4">
									<smart:singleSelect isAddDefaltOption="true" isNotNull="true" verify="required"
							...
							<smart:gridRow>
								...
								<smart:gridColumn colPart="4">
									<smart:singleSelect isAddDefaltOption="true"
										name="dismissalMode.id" labelName="免职决定做出方式：" shortName="免职决定方式" display="block"
								...
								<smart:gridColumn colPart="4">
									...
									<smart:singleSelect id="jobLevel" labelName="免职后职级：" name="newJobLevel.id"
														display="block"
