		...
		<smart:cardHead>
			<smart:gridRow>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="降职" cite="true"></smart:breadcrumbNavMenuItem>
							...
							<smart:gridRow>
								<smart:gridColumn colPart="4">
									<smart:singleSelect id="postCode" isAddDefaltOption="true"
										...
										verify="required" initSelectedKey="${jobShift.newPostCode.id}"
								...
								<smart:gridColumn colPart="4">
									<smart:singleSelect id="postCode" isAddDefaltOption="true"
										...
										url="dictquery/sub/code/GBT_12407_2008"
										 verify="required" initSelectedKey="${jobShift.newJobLevel.id}"
										isNotNull="true" isSaveShowName="true"
										inputShowName="postName"></smart:singleSelect>
								</smart:gridColumn>
								<smart:gridColumn colPart="4">
