		...
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="启动年度培训考核" cite="true"></smart:breadcrumbNavMenuItem>
				</smart:breadcrumbNavMenu>
			</smart:cardHead>
			<smart:cardBody>
				<smart:form action="ofcflow/train/saveYearPlan">
					<smart:fromTokenTag/>
					<smart:gridRow>
						<smart:gridRow>
							<smart:title title="启动年度培训考核" style="margin-top: 5px;"
								color="blue" />
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:textInput name="name" labelName="年度培训考核名称："
									value="${trainYearPlan.name}" placeholder="年度培训考核名称"></smart:textInput>
									<smart:textInput type="hidden" id="id" name="id" value="${trainYearPlan.id }"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:textInput name="startDate" labelName="开始日期："
									value="${trainYearPlan.startDate}"  id="startDate" placeholder="开始日期"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:textInput name="endDate" labelName="结束日期：" id="endDate"
									value="${trainYearPlan.endDate}"  placeholder="结束日期"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:textInput name="description" labelName="描述："
									value="${trainYearPlan.description}" placeholder="描述"></smart:textInput>
							</smart:gridColumn>
						</smart:gridRow>
						<smart:gridRow>
							<smart:gridColumn colPart="4" colOffset="3">
								<smart:checkbox isSwitch="true" labelName="状态"
									filter="checkstate" checkedKey="${trainYearPlan.state}"  name="states" other="lay-text='ON|OFF'" />
