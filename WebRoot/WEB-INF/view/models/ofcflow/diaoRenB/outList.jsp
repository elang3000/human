			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							<smart:tabPanelItem turnurl="ofcflow/diaorenB/index" show="false"
								eId="" itemName="调入情况列表"></smart:tabPanelItem>
							<smart:tabPanelItem show="true" eId="" itemName="调出情况列表"></smart:tabPanelItem>
						...
						<smart:form>
							<smart:gridRow>
								<smart:gridColumn colPart="4">
									<smart:singleSelect labelName="调出人员单位：" name="sourceOrgan.id"
								...
								<smart:gridColumn colPart="3">
									<smart:buttonGroup container="true">
										...
										<shiro:hasPermission name="ADD_DIAOREN_OUT_BTN">
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/diaorenOutB/outList"
							height="full-210" text="未获取到数据！">
							<tr>
								<smart:tableItem field="sourceOrgan" width=".4">调出单位</smart:tableItem>
							...
							<script type="text/html" id="navListToolBar">
										{{#  if(d.status=="0"){ }}
										<shiro:hasPermission name="EDIT_DIAOREN_OUT_BTN">
											<a class="layui-btn layui-btn-xs layui-btn-default" lay-event="edit"  title="编辑">
												<i class="fa fa-edit"></i>
											</a>
										</shiro:hasPermission>
										<shiro:hasPermission name="REMOVE_DIAOREN_OUT_BTN">
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '调出管理',
					size : 'full',
					url : "ofcflow/diaorenOutB/servantList?id="+data.data.id,
					scrollbar : false
				});
			}
			,delete : function(data) {
				smart.confirm({
					title:'提示',
					message:'您确定要删除这条记录？',
					url:'ofcflow/diaorenOutB/delete',
			...
			,view : function(data) {
				smart.show({
					title : '调出管理',
					size : 'full',
					url : "ofcflow/diaorenOutB/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
				...
				layer.confirm('请选择调入方式!', {
				  btn: ['本区','外区'] //按钮
					...
					smart.show({
						...
						size : 'full',
						params : {areaType:2},
						url : "ofcflow/diaorenOutB/selectOrg",
						scrollbar : false
					});
				});
			}
