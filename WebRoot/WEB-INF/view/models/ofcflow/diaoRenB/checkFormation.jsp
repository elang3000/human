			...
			<smart:cardBody>
				<smart:form id="editForm">
					...
					<smart:gridRow>
						<c:if test="${d.areaType=='1'}">
							<smart:gridColumn colPart="4">
								<smart:singleSelect labelName="人员来源单位：" name="sourceOrgan.id"
									...
									url="system/organ/node/queryAll?organTreeId=394e21fa-1eb6-42ee-ba32-50655fa16517&organNodeType=sy"
						...
						<smart:gridColumn colPart="4">
							<smart:textInput name="sumNumber" id="sumNumber" labelName="调任总人数" placeholder="调任总人数，自动计算"
					...
					<smart:gridRow>
						<smart:gridColumn colPart="4">
							<smart:numberInput name="plusKeLeaderNum" min="0" max="1000" type="text"
								id="plusKeLeaderNum" onBlur="sumnumber()" labelName="乡科级正职（领导）调任人数"
						...
						<smart:gridColumn colPart="4">
							<smart:numberInput name="plusKeNoLeaderNum" min="0" type="text"
								...
								labelName="乡科级正职（非领导）调任人数" value="${d.plusKeNoLeaderNum}"
					...
					<smart:gridRow>
						<smart:gridColumn colPart="4">
							<smart:numberInput name="minusKeLeaderNum" min="0" max="1000" type="text"
								id="minusKeLeaderNum" onBlur="sumnumber()" labelName="乡科级副职（领导）调任人数"
						...
						<smart:gridColumn colPart="4">
							<smart:numberInput name="minusKeNoLeaderNum" min="0" type="text"
								...
								labelName="乡科级副职（非领导）调任人数" value="${d.minusKeNoLeaderNum}"
								display="block" isInt="true"></smart:numberInput>
						</smart:gridColumn>
					</smart:gridRow>
					<smart:gridRow>
						<smart:gridColumn colPart="4">
							<smart:numberInput name="clerkNumber" min="0" max="1000" type="text"
								id="clerkNumber" onBlur="sumnumber()" labelName="科员级调任人数"
						...
						<smart:gridColumn colPart="4">
							<smart:numberInput name="cClerkNumber" min="0" max="1000" type="text"
								id="cClerkNumber" onBlur="sumnumber()" labelName="办事员级调任人数"
		...
		form.on('submit(save)', function (data) {//表单保存
			...
			smart.confirm({
				...
				callback : function(){
					...
					window.location.href="ofcflow/diaorenB/servantList?id="+this.data;
				}
			});
		});
	</smart:scriptHead>
