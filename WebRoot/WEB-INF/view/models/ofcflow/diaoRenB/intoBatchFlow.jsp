				...
				<smart:form id="editForm">
					...
					<smart:gridRow colSpace="5">
						<smart:gridColumn colPart="12" deviceType="md">
							<smart:table id="navigationList" url="ofcflow/diaorenB/intoServantList?id=${d.id}" text="未获取到数据！">
								<tr>
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '编辑调入信息',
					size : 'full',
					url : "ofcflow/diaorenB/servantView?isFlow=${isFlow}&status=${d.status}&areaType=${d.areaType}&id="+data.data.id,
					scrollbar : false
				});
			}
			,view : function(data) {
				smart.show({
					title : '查看调入信息',
					size : 'full',
					url : "ofcflow/diaorenB/servantView?status=${d.status}&areaType=${d.areaType}&id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
