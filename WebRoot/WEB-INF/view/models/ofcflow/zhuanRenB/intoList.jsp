			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem turnurl="ofcflow/zrtlbOutB/index" show="false"
								eId="" itemName="转出情况列表"></smart:tabPanelItem>
							<smart:tabPanelItem turnurl="ofcflow/zrtlbIntoB/flow" show="false"
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/zrtlbIntoB/intoList"
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '同类别转任管理',
					size : 'full',
					url : "ofcflow/zrtlbIntoB/servantList?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '同类别转任管理',
					size : 'full',
					url : "ofcflow/zrtlbIntoB/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
