			...
			<smart:cardBody>
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/zrtlbOutB/outList"
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			...
			edit : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrtlbOutB/servantList?id="+data.data.id,
					scrollbar : false
				});
			}
			...
			,view : function(data) {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrtlbOutB/view?id="+data.data.id,
					scrollbar : false
				});
			}
			,reload : function(){
		...
		<smart:buttonScriptAction>
			...
			add : function() {
				smart.show({
					title : '转出管理',
					size : 'full',
					url : "ofcflow/zrtlbOutB/selectOrg",
					scrollbar : false
				});
			}
		 </smart:buttonScriptAction>
