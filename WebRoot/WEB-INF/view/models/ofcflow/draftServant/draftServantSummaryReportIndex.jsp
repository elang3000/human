				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList" url="ofcflow/draftServantReportResult/list"
							height="full-205" text="未获取到数据！">
							<tr>
								<smart:tableItem field="creater" width="150" sort="true">创建者</smart:tableItem>
<%--								<smart:tableItem field="unitName" width="150" sort="false">签发单位名称</smart:tableItem>--%>
								<smart:tableItem field="createTime" width="155" sort="false">创建时间</smart:tableItem>
								<smart:tableItem field="serialNumber" width="155" sort="false">序列号</smart:tableItem>
								<smart:tableItem field="signer" width="138" sort="false">签发人</smart:tableItem>
								<smart:tableItem field="isAgree" width="125" sort="false">是否市局同意</smart:tableItem>
								<smart:tableItem field="total" width="125" sort="true">总共汇总条数</smart:tableItem>
								<smart:tableItem field="total310" width="125" sort="true">总共310人数</smart:tableItem>
								<smart:tableItem field="totalGwy" width="125" sort="false">公务员人数</smart:tableItem>
								<smart:tableItem field="totalGwy310" width="125" sort="false">公务员310人数</smart:tableItem>
								<smart:tableItem field="totalCg" width="125" sort="false">参公人数</smart:tableItem>
								<smart:tableItem field="totalCg310" width="125" sort="false">参公310人数</smart:tableItem>
