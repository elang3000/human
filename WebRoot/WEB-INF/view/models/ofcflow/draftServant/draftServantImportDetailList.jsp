...
<%--								<smart:gridColumn colPart="3">
								...
								<smart:gridColumn colPart="3">
									<smart:singleSelect name="importStatus" id="importStatus" display="inline" labelName="状态"
														data="[{'key':'1','value':'导入成功'},{'key':'0','value':'导入失败'}]"></smart:singleSelect>
								</smart:gridColumn>
								<smart:gridColumn colPart="3">
					...
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList1" url="ofcflow/draftServant/draftServantBeforePage?id=${importId}"
							...
							<tr>
								...
								<smart:tableItem field="importStatusStr" width="120" sort="false">录用情况</smart:tableItem>
