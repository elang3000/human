...
<smart:initHead title="长宁区人事管理信息系统--汇总详情" />
</head>
<smart:body>
	<smart:grid>
		<smart:card>
			...
			<smart:cardBody>
				...
				<smart:gridRow colSpace="5">
					...
					<smart:gridColumn colPart="6">
						<smart:infoShowerLabel infoname="310开头总人数"
				...
				<smart:gridRow colSpace="5">
					...
					<smart:gridColumn colPart="6" >
						<smart:infoShowerLabel infoname="310开头人数"
					...
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList1"
							...
							text="未获取到数据！" limits="10,50,100,500">
							<tr>
								...
								<smart:tableItem field="draftUnitName" width="170" sort="true">录用单位</smart:tableItem>
								...
								<smart:tableItem field="employComment" width="240" sort="false">录用鉴定评语</smart:tableItem>
					...
					<smart:gridColumn colPart="12" deviceType="md">
						<smart:table id="navigationList2"
							...
							<tr>
								<smart:tableItem field="name" width="150" sort="false">姓名</smart:tableItem>
								<smart:tableItem field="cardNo" width="190" sort="false">身份证</smart:tableItem>
								<smart:tableItem field="draftUnitName" width="180" sort="true">录用单位</smart:tableItem>
								<smart:tableItem field="draftDeptName" width="150" sort="true">录用部门</smart:tableItem>
								<smart:tableItem field="yearTip" width="150" sort="true">年度</smart:tableItem>
								<smart:tableItem field="sex" width="150" sort="false">性别</smart:tableItem>
								<smart:tableItem field="servantType" width="100" sort="true">人员类型</smart:tableItem>
								<smart:tableItem field="employComment" width="230" sort="false">录用鉴定评语</smart:tableItem>
								<smart:tableItem field="employSituation" width="80" sort="false">录用情况</smart:tableItem>
								<smart:tableItem field="employResult" width="80" sort="false">录用标识</smart:tableItem>
								<smart:tableItem align="center" fixed="right" unresize="true"
									width="150" toolbar="navListToolBar2">操作</smart:tableItem>
							</tr>
							<smart:tableToolBar id="navListToolBar2">
								<smart:tableToolBtn theme="warm" event="view" title="查看">
									<smart:icon icon="eye"></smart:icon>
								</smart:tableToolBtn>
								<c:if test="${dsr.isAgree==1}">
				...
				<smart:gridRow>
					<smart:form id="editForm">
						...
						<smart:gridColumn colPart="6">
								...
								<c:if test="${dsr.totalCg!=0}">
									 <smart:button size="sm" method="downloadcg1" title="参公请示文件下载">
											下载
									</smart:button>
								</c:if>
						</smart:gridColumn>
						...
						<smart:gridColumn colPart="6">
							<div style="width: 100%;">
								...
								<c:if test="${dsr.totalGwy!=0}">
									<smart:button
										size="sm" method="downloadgwy2" title="公务员审核文件下载">
										下载
									</smart:button>
								</c:if>
							</div>
						...
						<smart:gridColumn colPart="6">
							<div style="width: 100%;">
								...
								<c:if test="${dsr.totalCg!=0}">
									 <smart:button
										size="sm" method="downloadcg2" title="参公审核文件下载">
										下载
									</smart:button>
								</c:if>
							</div>
						...
						<smart:gridColumn colPart="6">
							<div style="width: 100%;">
								...
								<c:if test="${dsr.totalGwy!=0}">
								  <smart:button
										size="sm" method="downloadgwy3" title="公务员非310开头人员文件下载">
										下载
									</smart:button>
								</c:if>
							</div>
						...
						<smart:gridColumn colPart="6">
							<div style="width: 100%;">
								...
								<c:if test="${dsr.totalCg!=0}">
									<smart:button
										size="sm" method="downloadcg3" title="参公非“310”开头人员文件下载">
										下载
									</smart:button>
								</c:if>
							</div>
					...
					<smart:gridColumn colPart="4" deviceType="md" colOffset="4">
						<smart:buttonGroup container="true">
							...
							<c:if test="${empty dsr.isAgree}">
								<shiro:hasPermission name="DRAFTSERVANT_CONFIM_AGREE">
