			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab" style="margin-left:10px;margin-right:10px;">
						<smart:tabPanel>
							<smart:tabPanelItem show="false"  eId="" itemName="社工人员登记信息" turnurl="socialworker/main?id=${id}"></smart:tabPanelItem>
 ...
 --%>							<smart:tabPanelItem show="true" eId="" itemName="其他信息"></smart:tabPanelItem>
				...
				<smart:accordionPanel id="panel" isAccordion="true">
					<smart:accordionPanelItem title="职务信息" isShow="true">
						<smart:table id="postNavigationList" url="social/post/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！" >
							<tr>
					...
					<%-- <smart:accordionPanelItem title="录聘信息">
						<smart:table id="employNavigationList" url="socialWorker/employ/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="试用信息">
						<smart:table id="probationNavigationList" url="socialWorker/probation/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="职级信息">
						<smart:table id="jobLevelNavigationList" url="socialWorker/jobLevel/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="专业技术任职资格信息">
						<smart:table id="competenceNavigationList" url="socialWorker/competence/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！" >
							<tr>
					 ...
					 <smart:accordionPanelItem title="学历信息">
						<smart:table id="educationNavigationList" url="social/education/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="学位信息">
						<smart:table id="degreeNavigationList" url="social/degree/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
				...
				<%--	<smart:accordionPanelItem title="学习（培训、进修）信息">
						<smart:table id="studyNavigationList" url="socialWorker/study/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="奖励信息">
						<smart:table id="rewardNavigationList" url="socialWorker/reward/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="考核信息">
						<smart:table id="assessmentNavigationList" url="socialWorker/assessment/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="简历信息">
						<smart:table id="experienceNavigationList" url="social/experience/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<%-- <smart:accordionPanelItem title="家庭信息">
						<smart:table id="familyNavigationList" url="socialWorker/family/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="登记信息">
						<smart:table id="registrationNavigationList" url="socialWorker/registration/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="退出（调出）信息">
						<smart:table id="outMgrNavigationList" url="socialWorker/outMgr/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="进入（调入）信息">
						<smart:table id="intoMgrNavigationList" url="socialWorker/intoMgr/pageList?Id=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
		...
		<smart:tableScriptAction tableId="employNavigationList" checkbox="true" sort="true" rowEdit="true">
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/employ/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="probationNavigationList" checkbox="true" sort="true" rowEdit="true">
				edit : function(data) {
					smart.show({
						title:'试用子集修改',
						size:'full',
						url:'socialWorker/probation/edit',
						params:{
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/probation/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="jobLevelNavigationList" checkbox="true" sort="true" rowEdit="true">
				edit : function(data) {
					smart.show({
						title:'职级子集修改',
						size:'full',
						url:'socialWorker/jobLevel/edit',
						params:{
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/jobLevel/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="familyNavigationList" checkbox="true" sort="true" rowEdit="true">
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/family/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="competenceNavigationList" checkbox="true" sort="true" rowEdit="true">
				edit : function(data) {
					smart.show({
						title:'资格子集修改',
						size:'full',
						url:'socialWorker/competence/edit',
						params:{
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/competence/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="rewardNavigationList" checkbox="true" sort="true" rowEdit="true">
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/reward/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="punishNavigationList" checkbox="true" sort="true" rowEdit="true">
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/punish/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="assessmentNavigationList" checkbox="true" sort="true" rowEdit="true">
				edit : function(data) {
					smart.show({
						title:'编辑考核信息',
						size:'full',
						url:'socialWorker/assessment/edit',
						params:{
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/assessment/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="registrationNavigationList" checkbox="true" sort="true" rowEdit="true">
				edit : function(data) {
					smart.show({
						title:'编辑登记信息',
						size:'full',
						url:'socialWorker/registration/edit',
						params:{
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/registration/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="outMgrNavigationList" checkbox="true" sort="true" rowEdit="true">
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/outMgr/delete',
						params:{id:data.data.id},
		...
		<smart:tableScriptAction tableId="intoMgrNavigationList" checkbox="true" sort="true" rowEdit="true">
				...
				delete : function(data) {
					smart.confirm({
						title:'提示',
						message:'确认删除此项？',
						url:'socialWorker/intoMgr/delete',
						params:{id:data.data.id},
