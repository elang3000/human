			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							<smart:tabPanelItem show="false" eId="" itemName="社工人员登记"
				...
				<smart:accordionPanel id="panel" isAccordion="true">
					<smart:accordionPanelItem title="职务子集" isShow="true">
						<smart:table id="postNavigationList" url="ofc/post/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！" >
							<tr>
					...
					<smart:accordionPanelItem title="录聘子集">
						<smart:table id="employNavigationList" url="ofc/employ/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="试用子集">
						<smart:table id="probationNavigationList" url="ofc/probation/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="职级子集">
						<smart:table id="jobLevelNavigationList" url="ofc/jobLevel/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="专业技术任职资格子集">
						<smart:table id="competenceNavigationList" url="ofc/competence/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！" >
							<tr>
					...
					<smart:accordionPanelItem title="学历子集">
						<smart:table id="educationNavigationList" url="ofc/education/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="学位子集">
						<smart:table id="degreeNavigationList" url="ofc/degree/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="学习（培训、进修）子集">
						<smart:table id="studyNavigationList" url="ofc/study/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="奖励子集">
						<smart:table id="rewardNavigationList" url="ofc/reward/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="处分子集">
						<smart:table id="punishNavigationList" url="ofc/punish/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
								<smart:tableItem field="category" width=".2" sort="false">人员受奖惩类别 </smart:tableItem>
					...
					<smart:accordionPanelItem title="考核子集">
						<smart:table id="assessmentNavigationList" url="ofc/assessment/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="简历子集">
						<smart:table id="experienceNavigationList" url="ofc/experience/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="家庭子集">
						<smart:table id="familyNavigationList" url="ofc/family/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="登记子集">
						<smart:table id="registrationNavigationList" url="ofc/registration/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
								...
								<smart:tableItem field="registrationDate" width=".3" sort="false">公务员登记日期</smart:tableItem>
							</tr>
						</smart:table>
					</smart:accordionPanelItem>
					
					<smart:accordionPanelItem title="退出（调出）子集">
						<smart:table id="outMgrNavigationList" url="ofc/outMgr/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
					...
					<smart:accordionPanelItem title="进入（调入）子集">
						<smart:table id="intoMgrNavigationList" url="ofc/intoMgr/pageList?servantId=${id}" height="full" page="false" limit="10000" text="未找到用户数据！">
							<tr>
