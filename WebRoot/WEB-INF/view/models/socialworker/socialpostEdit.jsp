...
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardBody>
				<smart:form id="editForm" action="social/post/save">
					<smart:fromTokenTag/>
							...
							<smart:grid>
								<smart:gridRow>
									<smart:gridColumn colPart="4">
										...
										<smart:textInput type="hidden" name="pid" value="${socialWorker.id}"></smart:textInput>
								...
								<smart:gridRow>
									...
									<smart:gridColumn colPart="4">
										<smart:singleSelect labelName="管理类别：" name="nowJobLevel.id" display="block" initSelectedKey="${socialWorker.nowJobLevel.id}" url="dictquery/sub/code/DM203" isAddDefaltOption="true"></smart:singleSelect>
									</smart:gridColumn>
								</smart:gridRow>
