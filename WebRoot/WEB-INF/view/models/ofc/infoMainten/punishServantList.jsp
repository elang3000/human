...
<smart:initHead title="事项申请--处分管理" />
</head>
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardHead>
				<smart:gridRow>
					<smart:breadcrumbNavMenu separator=">">
						...
						<smart:breadcrumbNavMenuItem iname="处分管理" cite="true"></smart:breadcrumbNavMenuItem>
			...
			<smart:cardBody>
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem show="false" eId="" itemName="处分备案"
								turnurl="ofc/punish/punishList"></smart:tabPanelItem>
						</smart:tabPanel>
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn>
						<smart:table id="punishNavigationList" url="ofc/pageList"
		...
		<smart:tableScriptAction tableId="punishNavigationList" checkbox="true"
			sort="true" rowEdit="true">
				edit : function(data) {
					...
					title : '新增处分',
					size : 'full',
					url : 'ofc/punish/edit?servantId='+data.data.id,
					scrollbar : false,
					});
				}
