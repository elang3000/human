				...
				<smart:gridRow>
					...
					<smart:gridColumn colPart="10">
						<smart:gridRow>
							<smart:tabPanelParent filter="tab" style="margin-left:10px;margin-right:10px;">
								<smart:tabPanel>
									...
									<smart:tabPanelItem show="false" eId="" itemName="历史人员" turnurl="ofc/oldList"></smart:tabPanelItem>
									<smart:tabPanelItem show="true" eId="" itemName="进出管理"></smart:tabPanelItem>
								</smart:tabPanel>
								...
								<smart:form id="searchForm">
									<smart:gridRow>
										<smart:gridColumn colPart="4">
											<smart:singleSelect labelName="事项类型：" display="block" name="sex.id" isAddDefaltOption="true">
											</smart:singleSelect>
											<smart:textInput type="hidden" name="departId"></smart:textInput>
										</smart:gridColumn>
										<smart:gridColumn colPart="4">
											<smart:singleSelect labelName="出入类型：" display="block" name="personSubjection.id" isAddDefaltOption="true">
											</smart:singleSelect>
										</smart:gridColumn>
										<smart:gridColumn colPart="4">
						...
						<smart:gridRow colSpace="5">
							<smart:gridColumn>
								<smart:table id="navigationList" url="ofc/intoPageList"
									height="full-315" sortField="cardnum" sortType="asc"
