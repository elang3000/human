...
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardBody>
				<smart:form id="editForm" action="ofc/punish/save">
					<smart:fromTokenTag/>
							...
							<smart:grid>
								<smart:gridRow>
									<smart:gridColumn colPart="4">
										...
										<smart:textInput type="hidden" id = "servantId" name="servant.id" value="${servant.id }"></smart:textInput>
									</smart:gridColumn>
								</smart:gridRow>
								<%-- <smart:gridRow>
								...
								<smart:gridRow>
									<smart:gridColumn colPart="12">
										<smart:continuousSelect id="punishCode" labelName="惩戒名称：" inputName="punishCode.id" codeTypeCode="GBT_8563_3_2005" inputVal="${punish.punishCode.id}" valType="ID" widthPercent="0.5" verify="required" isNotNull="true"  isSaveShowName="true" inputShowName="punishName" allOrLast="last"/>
									</smart:gridColumn>
								</smart:gridRow>
								...
								<smart:gridRow>
									<smart:gridColumn colPart="4">
										<smart:date labelName="惩戒批准日期 ：" display="block" name="punishApprovalDate" id="punishApprovalDate" value="${punish.punishApprovalDate}" verify="required" isNotNull="true"></smart:date>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
										<smart:singleSelect labelName="受惩戒原因：" name="punishReason.id" display="block" url="dictquery/sub/code/DM021_PUNISH" isAddDefaltOption="true" initSelectedKey="${punish.punishReason.id }"></smart:singleSelect>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
										<smart:textInput labelName="受惩戒说明：" name="punishDescription" value="${punish.punishDescription}" ></smart:textInput>
									</smart:gridColumn>
								</smart:gridRow>
