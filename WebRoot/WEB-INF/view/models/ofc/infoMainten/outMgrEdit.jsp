...
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardBody>
				<smart:form id="editForm" action="ofc/outMgr/save">
					<smart:fromTokenTag/>
							...
							<smart:grid>
								...
								<smart:gridRow>
									<smart:gridColumn colPart="12">
										<smart:continuousSelect id="category" labelName="调出本单位类别：" inputName="category.id" codeTypeCode="GBT_12405_2008" inputVal="${outMgr.category.id}" valType="ID" widthPercent="0.5"/>
									</smart:gridColumn>
								</smart:gridRow>
								
								<smart:gridRow>
									<smart:gridColumn colPart="12">
										<smart:continuousSelect id="reasonType" labelName="调动原因：" inputName="reasonType.id" codeTypeCode="DM015" inputVal="${outMgr.reasonType.id}" valType="ID" widthPercent="0.5"/>
									</smart:gridColumn>
								</smart:gridRow>
								
								<smart:gridRow>
									<smart:gridColumn colPart="4">
										<smart:date labelName="调出本单位日期：" display="block" name="outDate" id="outDate" value="${outMgr.outDate}"></smart:date>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
										<smart:textInput labelName="调往单位名称：" name="gotoUnitName" value="${outMgr.gotoUnitName}" ></smart:textInput>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
