...
<smart:body>
		...
		<smart:card>
			...
			<smart:cardBody>
				...
				<smart:gridRow>
					<smart:tabPanelParent filter="tab"
						...
						<smart:tabPanel>
							...
							<smart:tabPanelItem  show="true" eId="" itemName="事业人员综合查询"></smart:tabPanelItem>
						...
						<div class="layui-col-md4">
							<div class="layui-form-item">
								<label class="layui-form-label">查询条件：</label>	
									<div class="layui-input-block">
									<select name="code1" mysign url="analysis/general/queryList/I" lay-filter="business1" lay-search initselectedkey="3">
				...
				<smart:gridRow colSpace="5">
					<smart:gridColumn>
						<smart:table id="navigationList" url="business/personel/query"
	...
	<smart:scriptHead models="table,form,layer,element,laydate">
		...
		<smart:tableScriptAction tableId="navigationList" checkbox="true"
			sort="true" rowEdit="true">
				view : function(data) {
					...
					title : '公务员信息',
					size : 'full',
					url : 'publicInstitution/main?id='+data.data.id,
					scrollbar : false,
				});
				}
		...
		form.on('select(business1)', function(data){
