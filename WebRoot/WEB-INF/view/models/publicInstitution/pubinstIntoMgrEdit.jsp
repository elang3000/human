...
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardBody>
				<smart:form id="editForm" action="pubinst/intoMgr/save">
					<smart:fromTokenTag/>
					<smart:gridRow colSpace="5">
						<smart:gridColumn>
							<smart:grid>
								...
								<smart:gridRow>
									<smart:gridColumn colPart="12">
										<smart:continuousSelect id="enterReason" labelName="进入原因：" inputName="enterReason.id" codeTypeCode="DM015" inputVal="${intoMgr.enterReason.id}" valType="ID" widthPercent="0.3333"/>
									</smart:gridColumn>
								</smart:gridRow>
								...
								<smart:gridRow>
									<smart:gridColumn colPart="4">
										<smart:textInput labelName="前单位职务级别：" name="formerUnitRank" value="${intoMgr.formerUnitRank}" ></smart:textInput>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
										<smart:numberInput min="0" labelName="基层工作时间:" placeholder="单位（月）" name="intoBasicWorkTime" value="${intoMgr.intoBasicWorkTime}"  display="block" type="text"></smart:numberInput>
									</smart:gridColumn>
								</smart:gridRow>
							</smart:grid>
						</smart:gridColumn>
