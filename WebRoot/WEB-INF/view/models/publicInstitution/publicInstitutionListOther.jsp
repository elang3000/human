		...
		<smart:card>
			<smart:cardHead>
				<smart:breadcrumbNavMenu separator=">">
					...
					<smart:breadcrumbNavMenuItem iname="其它人员信息维护" cite="true"></smart:breadcrumbNavMenuItem>
									...
									<div class="layui-tab">
										...
										<div class="layui-tab-content">
											...
											<smart:gridRow colSpace="5" >
												<smart:gridColumn >
													<smart:table id="navigationList_ofcList" url="publicInstitution/pageListOther" height="300" text="未找到用户数据！" page="true">
														<tr>
															<%-- <smart:tableItem isCheckbox="true">全选</smart:tableItem> --%>
															<smart:tableItem field="name" width="110" sort="true">姓名</smart:tableItem>
															<smart:tableItem field="sex" width="90" sort="true">性别</smart:tableItem>
															...
															<smart:tableItem align="center" width="185" fixed="right"
