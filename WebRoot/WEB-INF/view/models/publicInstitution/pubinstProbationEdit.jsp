...
<smart:body>
	<smart:grid>
		<smart:card>
			<smart:cardBody>
				<smart:form id="editForm" action="pubinst/probation/save">
					<smart:fromTokenTag/>
						...
						<smart:gridColumn>
							<smart:grid>
								...
								<smart:gridRow>
									...
									<smart:gridColumn colPart="4">
										<smart:date labelName="结束日期 ：" placeholder="试用结束日期" display="block" name="endDate" id="endDate" value="${probation.endDate}"></smart:date>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
										<smart:date labelName="转正日期：" placeholder="入职转正日期" display="block" name="becomeDate" id="becomeDate" value="${probation.becomeDate}"></smart:date>
									</smart:gridColumn>
									<smart:gridColumn colPart="4">
										<smart:textInput labelName="批准文号：" placeholder="入职转正批准文号" name="becomeNo" value="${probation.becomeNo }"></smart:textInput>
									</smart:gridColumn>
								</smart:gridRow>
								
								<smart:gridRow>
									<smart:gridColumn colPart="8">
										<smart:continuousSelect id="conclusion" labelName="考核结论："  inputName="conclusion.id" codeTypeCode="DM018" inputVal="${probation.conclusion.id}" valType="ID" widthPercent="0.3333"/>
									</smart:gridColumn>
								</smart:gridRow>
							</smart:grid>
						</smart:gridColumn>
