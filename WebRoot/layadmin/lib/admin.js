 ;layui.define("view",function(e){
	 ...
	 A = {
		 ...
		 sideFlexible : function(e) {
			 ...
			 "spread" === e 
			 ? (t.removeClass(x).addClass(g),s<2?i.addClass(v):i.removeClass(v),i.removeClass(C))
			 : (t.removeClass(g).addClass(x),s<2?i.removeClass(C):i.addClass(C),i.removeClass(v)),
		 ...
		 resize : function(e) {
			 ...
			 e(),
			 A.resizeFn[i] = e,o.on("resize", A.resizeFn[i])
		 },
		 resizeFn : {},
		 runResize : function() {
			 var e = layui.router(),
	...
	_=A.events={
		 ...
		 setTheme : function(e) {
			 ...
			 || (e.addClass(y).siblings(".layui-this").removeClass(y),
				 a.color[i] && (
						 a.color[i].index = i,A.theme({
							 color:a.color[i]
						 })
				 ))
		 },
		 rollPage:function(e,i) {
			 var t = a("#smart_app_tabsheader"),
			 n = t.children("li"),
			 ...
			 if ("left" === e){
				 ...
				 n.each(function(e, i){
					 ...
					 s = n.position().left;
					 if (s >= o) 
						 return t.css("left",-s),!1
				 })
			} else "auto" ===e ? !function(){
				var e,
				o = n.eq(i);
				if (o[0]) {
					if( e = o.position().left,e<-l)
						return t.css("left",-e);
		 ...
		 closeOtherTabs : function(e) {
			 var i = "smart-system-pagetabs-remove";
			 "all" === e ? 
			 (
					 a(z + ":gt(0)").remove(), 
	 ...
	 !function() {
		 ...
		 n.pageTabs || (a("#smart_app_tabs").addClass(c),d.addClass("layadmin-tabspage-none")),
		 l.ie && l.ie < 10 && s.error("IE" + l.ie + "下访问可能不佳，推荐使用：Chrome / Firefox / Edge 等高级浏览器",{offset:"auto",id:"smart_error_brower"})
	 }(),
